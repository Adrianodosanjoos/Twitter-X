            ...
            <div className="flex space-x-3">
                ...
                <div className="flex-1">
                    <div className="flex items-center justify-between">
                        ...
                        <FontAwesomeIcon icon={faEllipsisH} className="text-gray-500 ml-2" />
                    </div>
                    ...
                    <div className="flex justify-between mt-4 text-gray-500 ">
                        ...
                        <div className="flex items-center cursor-pointer hover:text-yellow-400">
...
Tweet.propTypes = {
    tweet: PropTypes.shape({
        avatar: PropTypes.string.isRequired, // A prop 'avatar' deve ser uma string e é obrigatória
    }).isRequired, // A prop 'tweet' é um objeto e também é obrigatória
};